...
class Manager extends Employee {
    ...
    addManager(managerName, managerId, managerEmail, managerOfficePhone) {
        this.myEmployees.push(new Manager(managerName, managerId, managerEmail, managerOfficePhone));
    }
}
